...
type AccountFlow struct {
	...
	AccountBalance       *float64 `db:"account_balance" json:"account_balance,omitempty"`
	TargetAccountBalance *float64 `db:"target_account_balance" json:"target_account_balance,omitempty"`
