...
var (
	...
	ErrAccountNotFound = &Errno{Code: 10501, Message: "账户不存在"}

	ErrAccountFlowNotFound     = &Errno{Code: 10601, Message: "流水不存在"}
	ErrAccountFlowAssociateNil = &Errno{Code: 10602, Message: "对方名称不能为空"}
